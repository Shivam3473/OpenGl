...
int main()
{
    ...
    const float m = 1000.0f;    // mass of the small stars
    ...
    float pos_1_x = 0.6f; // Start 0.6 units to the right
    float pos_1_y = 0.0f;
    ...
    float vel_1_x = 0.0f;            // No horizontal velocity initially
    float vel_1_y = -1 * v_circular; // Shoot straight UP to begin the orbit
    float vel_2_x = -1 * v_circular;
    float vel_2_y = 0.0f;
    float vel_star_x = 0.0f;
    float vel_star_y = v_circular;
