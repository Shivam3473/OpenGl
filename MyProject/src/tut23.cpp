...
int main() {
    ...
    // Star
    particles[0].posMass = glm::vec4(0.0f, 0.0f, 0.0f, 1000.0f);
    ...
    // Planet 1
    particles[1].posMass = glm::vec4(r1, 0.0f, 0.0f, 10.0f);
    particles[1].velocity = glm::vec4(0.0f, -v1, 0.0f, 0.0f);

    // Planet 2
    particles[2].posMass = glm::vec4(0.0f, -r1, 0.0f, 10.0f);
    particles[2].velocity = glm::vec4(-v1, 0.0f, 0.0f, 0.0f);
